import 'package:day_night/thememode_selector_theme.dart';
  ...
  initialize(BuildContext context, ThemeModeSelectorThemeData myTheme) {
    ...
    _alignmentAnimation = AlignmentTween(
      ...
      CurvedAnimation(
        ...
        reverseCurve: const Interval(0.0, 0.9, curve: Curves.easeInBack),
    ...
    var earlyFade = CurvedAnimation(
      ...
      reverseCurve: const Interval(0.5, 1.0, curve: Curves.elasticIn),
    );
